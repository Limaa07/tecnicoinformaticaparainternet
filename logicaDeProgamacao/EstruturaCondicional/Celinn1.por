...
*/
	...
	funcao inicio()
	{
	       real nota1, nota2, nota3, media
	        ...
	        se( media >= 8 e media <= 10)
	        escreva(" Aluno seu conceito é: A")

	        senao se( media >= 7 e media <= 8)
	        escreva(" Aluno seu conceito é: B")

	        senao se( media >= 6 e media <= 7)
	        escreva(" Aluno seu conceito é: C")

	        senao se( media >= 5 e media <= 6)
	        escreva(" Aluno seu conceito é: D")

	        senao se( media >= 0 e media <= 5)
	        escreva(" Aluno seu conceito é: E")
